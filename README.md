...
1. Git clone ````https://github.com/PROCuuuba/Task2````
...
Запустив приложение вам будут доступны 2 кнопки:
* Первая кнопка ````Button1```` отвечает за анимацию вращения сделаная с помощью стандартной анимации.
* Вторая кнопка ````Button2```` отвечает за анимацию перемещения вправо сделаная с помощью библиотеки ````Tween````.
